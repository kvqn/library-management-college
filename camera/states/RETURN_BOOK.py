...
def cart_add(book_id : int):
    ...
    if db.transactions.checkIfCanBeReturned(book_id, STUDENT.id):
        ...
        TEXT_ERROR = interactables.Text(utils.Point(20,test.SCREEN_HEIGHT-20), 0.02, f"Book {book_id} cannot be returned.", utils.Color.RED, 2)
...
def setup(student : db.student.Student):
    logging.info("Setting state to RETURN_BOOK")
    global STUDENT
    STUDENT = student
