...
class Book:
    def __init__(self, id : str, name : str, author : str, total_count : int, available_count : int):
        self.id = id
        self.name = name
        self.author = author
